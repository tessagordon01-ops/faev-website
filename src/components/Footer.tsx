      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li><Link href="#for-groups" className="hover:text-black transition-colors">For Groups</Link></li>
              <li><Link href="/property-manager" className="hover:text-black transition-colors">For Property Managers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li><Link href="/brand-ambassadors" className="hover:text-black transition-colors">Brand Ambassadors</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <motion.a
              href="https://www.instagram.com/faev.app/"
              target="_blank"
            ...
            <motion.a
              href="https://www.tiktok.com/@faev_app"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.1 }}
              className="text-gray-400 hover:text-black transition-colors"
